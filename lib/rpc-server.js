...
var ServerRpc = function(serverHttp, opts) {
    ...
    this.io.on('connection', function(socket) {
        ...
        log('== self.clientChannels: ', Object.keys(self.clientChannels).length);
...
ServerRpc.prototype._transfer = function(serverSocket, clientId){
    ...
    for (var id in clients) {
        console.log(' - ', clients[id].remoteClientId);
...
ServerRpc.prototype.deleteChannel = function(id){
    ...
    log('== self.clientChannels: ', Object.keys(this.clientChannels).length);
};
