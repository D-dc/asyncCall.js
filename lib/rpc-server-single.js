...
function ServerSingleSocket(socket, options, server) {
    ...
    this.onConnected(function (){
        console.log('ServerSingleSocket connected!');
    ...
    this.onDisconnected(function (){
        console.log('ServerSingleSocket disconnected!');
        self.timeoutTimer = setTimeout(function(){
            self.server.deleteChannel(self.id);
            console.log('ServerSingleSocket channel deleted!', Object.keys(self.server.clientChannels).length);
        }, self.stateTimeout);
    });
}
