...
//     console.debug('New lease with ', this.leaseLifeTime, this.leaseRenewOnCall);
...
//     debug('Transfering Lease');
    

//     if(lease.isExpired){
//         debug(' Lease expired while transfering');
//         lease.renewOnExpire();
//         lease.invokeOnExpire = this.onExpired;
//         this.lease = lease;

//     }else{
//         debug(' Normal transfer of lease');
//         lease.renewOnRpc();
//         lease.invokeOnExpire = this.onExpired;
//         this.lease = lease;
//     }
